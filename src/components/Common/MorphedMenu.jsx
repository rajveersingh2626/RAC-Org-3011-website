...
/**
 * MorphedMenu - Framer Morphed Menu Component
 * Features smooth spring morphing panel, complete site navigation options,
 * 3D perspective link reveals, animated SVG hover arrows, sub-nav accordions,
 * user authentication state card, and dark/black theme with Rotaract Pink & Gold accents.
 */
export default function MorphedMenu({
  ...
  // Complete Site Navigation Links List
  const mainLinks = [
    {
      id: 'home',
      title: 'Home',
  ...
  return (
    <div ref={menuRef} style={{ position: 'relative', display: 'inline-block', zIndex: 9999 }}>
        ...
        >
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px', paddingBottom: '12px', borderBottom: '1px solid rgba(255, 255, 255, 0.1)' }}>
              ...
              {/* Close Button inside Menu Panel Header */}
              <button
                ...
                return (
                  <div key={link.id} style={{ perspective: '800px', perspectiveOrigin: 'bottom' }}>
                    ...
                    >
                      ...
                      {/* Expandable accordion trigger for District sub-tabs */}
                      {link.hasSubNav && (
                        <button
                    ...
                    {/* Sub-tabs List for Know Our District */}
            ...
            {/* Authentication & User Access Card */}
            <div
              style={{
                paddingTop: '14px',
                paddingBottom: '14px',
        ...
        {/* Rolling MENU Text Trigger (Hides when menu opens) */}
        <button
        ...
        >
          {/* Rolling Vertical Text Motion Container */}
          <div
            style={{
              position: 'relative',
              width: '100%',
