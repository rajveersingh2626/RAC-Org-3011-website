...
import { ArrowRight, ArrowUp, ArrowDown, MapPin, Sparkles, Heart, CheckCircle2, Shield, LogIn, Calculator, UserPlus, Send, X, Globe, Layers, ChevronLeft, ChevronRight, ChevronUp, ChevronDown } from 'lucide-react';
...
export default function PublicHome({ onNavigateDistrict, onNavigatePage, onOpenLoginModal }) {
  ...
  const liveVisitsCount = liveVisitsQuery.data?.count;
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px', flexWrap: 'wrap' }}>
            ...
            {typeof liveVisitsCount === 'number' && liveVisitsCount > 0 && (
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', marginTop: '16px', background: 'rgba(216, 27, 96, 0.08)', border: '1px solid rgba(216, 27, 96, 0.22)', padding: '6px 14px', borderRadius: '100px' }}>
                <span style={{ width: '7px', height: '7px', borderRadius: '50%', backgroundColor: '#22C55E', boxShadow: '0 0 8px #22C55E', animation: 'pulse 2s infinite' }} />
                <span style={{ fontSize: '0.80rem', fontWeight: 800, color: 'var(--rotaract-pink)', letterSpacing: '0.5px' }}>
                  {liveVisitsCount.toLocaleString('en-IN')} Global Visitors • RY 2026-27
                </span>
              </div>
            )}
          </div>
